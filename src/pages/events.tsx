    ...
    <Layout>
      ...
      <Section className="text-center">
        <Container>
          ...
          <p className="lead">
            All of the events are at Sarova Whitesands Beach Resort & Spa in Mombasa. If you’re
            unsure where in the hotel to go just ask a member of staff and they will be able to
          ...
          <Row className="mt-5 mb-n4">
            <Col lg={6} className="mb-4">
              <Card>
                ...
                <Card.Body>
                  <Card.Text>
                    In true Kenyan fashion, we will start things off with a welcome barbecue.{' '}
                    <br className="d-none d-lg-block" />
                    This will be an opportunity to settle in, enjoy the sunset, meet the other
                    guests and enjoy traditional Kenyan BBQ known as nyama choma!
                  </Card.Text>
                </Card.Body>
                <Card.Footer>
                  <dl>
            ...
            <Col lg={6} className="mb-4">
              <Card>
                ...
                <Card.Body>
                  <Card.Text>
                    Join us for our wedding ceremony by the beach to get us formally hitched! There
                    will be some light bitings and drinks, and since the Mendhi will follow a few
                    hours later you will have some time to relax and change in between.
                  </Card.Text>
                </Card.Body>
                <Card.Footer>
                  <dl>
            ...
            <Col lg={6} className="mb-4">
              <Card>
                ...
                <Card.Body>
                  <Card.Text>
                    Get out your Bollywood gear and dancing shoes, it’s time for our mendhi! This is
                    a traditional Asian ceremony with plenty of colours, food, music and of course
