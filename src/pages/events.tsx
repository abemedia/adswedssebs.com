                      ...
                      <>
                          ...
                          <Card>
                            ...
                            <Card.Body>
                              <Card.Text>
                                ...
                                barbecue. <br className="d-none d-lg-block" />
                                This will be an opportunity to settle in, enjoy the sunset, meet the
                                other guests and enjoy a traditional Kenyan BBQ, known as nyama
                                choma!
                              </Card.Text>
                            </Card.Body>
                            <Card.Footer>
                          ...
                          <Card>
                            ...
                            <Card.Body>
                              <Card.Text>
                                ...
                                will follow a few hours later, so you will have some time to relax
                          ...
                          <Card>
                            ...
                            <Card.Body>
                              <Card.Text>
                                ...
                                food, music and, of course, lots of dancing! The dress code for
                                ladies and gents is traditional Indian wear, think big and bright
                                for this night!
                              </Card.Text>
                            </Card.Body>
                            <Card.Footer>
                        ...
                        <Col lg={6} className="mb-4">
                          <Card>
                            ...
                            <Card.Body>
                              <Card.Text>
                                Once you have slept off the dancing from the night before, get
                                suited and booted for the wedding reception, to celebrate the final
                        ...
                        <Col lg={6} className="mb-4">
                          <Card>
                            ...
                            <Card.Body>
                              <Card.Text>
                                Get out your Bollywood gear and dancing shoes, it’s time for our
                                mendhi! This is a traditional Asian ceremony with plenty of colours,
                        ...
                        <Col lg={6} className="mb-4">
                          <Card>
                            ...
                            <Card.Body>
                              <Card.Text>
                                Once you have slept off the dancing from the night before, get
                                suited and booted for the wedding reception, to celebrate our final
                                evening together.
                                <br className="d-none d-lg-block d-xl-none" />
                                <br className="d-none d-lg-block" />
                                <br className="d-none d-lg-block" />
